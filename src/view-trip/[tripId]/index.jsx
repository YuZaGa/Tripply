            ...
            <div className="px-6 pb-6">
              <div className="flex items-stretch border border-stone-200 bg-white">
                <input
                  ...
                  className="flex-1 px-4 py-3 text-sm text-charcoal bg-transparent outline-none font-mono truncate"
                />
                <button
                  onClick={handleCopyLink}
                  className={"px-4 border-l border-stone-200 flex items-center gap-2 text-xs font-bold uppercase tracking-widest transition-colors " + (copied ? "bg-burnt-orange text-white" : "bg-stone-50 text-charcoal hover:bg-stone-100")}
                >
