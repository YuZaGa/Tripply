    ...
    <nav className="fixed w-full z-50 transition-all duration-300 bg-cream-50/80 backdrop-blur-md border-b border-charcoal/5">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link to="/create-trip" className="hidden sm:flex items-center justify-center px-6 h-11 rounded-full bg-burnt-orange text-sm font-semibold text-white hover:bg-burnt-orange/90 hover:shadow-md transition-all duration-200">
            Log In
          </Link>
