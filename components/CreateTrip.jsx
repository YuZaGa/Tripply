                ...
                <div className="space-y-16">
                    <section className="space-y-8">
                        <div className="flex items-center justify-between mb-8 border-b border-charcoal/10 pb-4">
                            ...
                            <span className="text-xs uppercase tracking-widest text-slate-muted">
                                Where & When
                            </span>
                        </div>

                        <div className="space-y-3">
                            <h2 className="text-sm font-medium uppercase tracking-wider text-charcoal">
                                Where to?
                            </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between bg-white/70 border border-slate-200 rounded-sm p-4 h-[62px]">
                                    <span className="text-xs uppercase font-medium tracking-widest text-slate-muted">
                                        Days
                                    </span>
                                    <div className="flex items-center space-x-6">
                                        <button
                                            onClick={() =>
                                                handleInputChange(
                                                    "noOfDays",
                                                    Math.max(1, (formData.noOfDays || 3) - 1)
                                                )
                                            }
                                ...
                                <label key={index} className="cursor-pointer relative group block">
                                    ...
                                    <div className="p-6 bg-white/50 border border-transparent rounded-sm hover:border-slate-200 transition-all duration-300 h-full flex flex-col items-center text-center space-y-3 shadow-sm">
                                        <div className="mb-1 emoji-icon transition-transform duration-300">
                                            <span className="material-symbols-outlined text-[32px] text-burnt-orange">
                                                {item.icon}
                                            </span>
                                        </div>
                                        ...
                                        <p className="text-xs text-slate-muted font-light">
                                            {item.desc}
                                        </p>
                                    </div>
                                </label>
                            ...
                            {SelectTravelsList.map((item, index) => (
                                <label key={index} className="cursor-pointer relative group block">
                                    ...
                                    <div className="p-5 bg-white/50 border border-transparent rounded-sm hover:border-slate-200 transition-all duration-300 h-full flex flex-col items-center text-center space-y-2 shadow-sm">
                                        <div className="mb-1 emoji-icon transition-transform duration-300">
                                            <span className="material-symbols-outlined text-[28px] text-burnt-orange">
                                                {item.icon}
                                            </span>
                                        </div>
                                        ...
                                        <p className="text-[10px] text-slate-muted font-light uppercase tracking-wide">
                                            {item.desc}
                                        </p>
                                    </div>
                                </label>
                            ...
                            {[
                                {
                                    id: "wanderer",
                                    title: "The Wanderer",
                                    desc: "You prefer the path less traveled. Hidden gems, scenic routes, and spontaneous discoveries define your journey.",
                                    img: "https://lh3.googleusercontent.com/aida-public/AB6AXuA5mD_bHBAyYT_R0Ayir5XV_FKDgEL1lmdxV6ooXwILJ7wbbGMaMLcu8VKADKaa2-VK9a5_DlLEPrydas62JRowdeh53zxC9t6eEneywVOMOuYnQwcJv0hnwBmgk_jUZl24pdBwKwVx_zbUDdfA2GpYioGx9s_Gjs2E76U6-y1ypUv-HQsyXFAE8_KprMLFv2OVZMCUzgcnT35_D84h5IfnUZOFB47BuC-PHjZ6R8F65pyOzDU5Klx8zNka3B64BIKck-3BuLH1ym8",
                                },
                                {
                                    id: "curator",
                                    title: "The Curator",
                                    desc: "History, art, and culture are your compass. You seek deep understanding, guided tours, and architectural marvels.",
                                    img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCz2E03COe1l5Ha1Th6BETpu8zTWdulN3JOukKZe2ic8J4VcpCRAe1M4a2YRDPWlDbLxqELrCX6Yxm9Qang_oLWGVTsQPY2sqY36h1o_5h1lB7rq3xhN1SQ7XnfRKiobMxQ-cQ2dKtw_vqipNAPJjV7_mv5P8dZvta3KsjRkPMBoxToTwkHkoBdToMfyyVUinIQCDV3h49HzUGhst9R3MnXnEwrs4hp-W0vyA3YsP0ykTsIQI15UZDFM8vq1ELzAEtR9_h2t7iS1-s",
                                },
                                {
                                    id: "epicurean",
                                    title: "The Epicurean",
                                    desc: "You travel taste-buds first. Michelin stars, local street food, and wine tastings are the highlights of your trip.",
                                    img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCEdCV_N3YJFMY278NEVoH1xt-57_X-VeFKd5ag3Rnp-ELdA9bkZvzjIktgRa75lrutGwCmGyO6dEjpAiozgL6UhryFT0H3obPoLRscM_YaosxwunRyTHFfCaf8r6uTsI6yLCcIVVRNnxqwYPt6g6ZBx_ysaDAHCugA_7VkTvVQK82N-58NxrsIU37X5F2QH8IvccctUbcLAKvOZE9A_u_y7muZ3hmbj7is4_CwJVJcy1B61g4FQJhnogSK_c-2HSf0Z0dzqNqzcLE",
                                },
                            ].map((style) => (
                    ...
                    <div className="pt-8 flex flex-col items-center">
                        ...
                        >
                            <span className="font-serif italic pr-2">
                                {loading ? (
                                    <AiOutlineLoading3Quarters className="h-5 w-5 animate-spin mr-2 inline" />
                                ) : null}
                        ...
                        <p className="mt-6 text-sm text-slate-muted italic font-serif">
                            Estimated build time:{" "}
                            <span className="text-burnt-orange">~30 seconds</span>
                        </p>
                    </div>
                </div>
            </div>
